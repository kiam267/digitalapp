...
export default function Home() {
  return (
    <>
      <MaxWidthWrapper>
        <div className="py-20 max-auto text-center flex flex-col items-center">
          <h1 className="text-4xl font-bold text-gray-900  tracking-tight sm:text-6xl">
            Your market place for heigh-quality{' '}
            <span className="text-violet-600">digital assets</span>
          </h1>
          <p className="mt-4 text-lg max-w-prose text-muted-foreground">
            wellcome to digitalapp . Every asset on our platform is verifyed by
            our team to ensure oue heighest quality standards
          </p>
